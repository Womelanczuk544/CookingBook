#include"pk_projekt_naglówki.h"
    ...
    Skladnik::Skladnik(string p_nazwa, int p_ile, string p_jednostka) : ile(p_ile), jednostka(p_jednostka)
    {
        nazwa = p_nazwa;
    }
    ostream& operator << (ostream& s, Skladnik& x)
    {
        s << x.nazwa << " ";
        s << x.ile << " ";
        s << x.jednostka;
    ...
    string Skladnik::GetNameV()
    {
        return nazwa;
    }
    pair<int, string> Skladnik::GetIleV()
    {
        pair<int, string> zestaw(ile, "skladnik");
        return zestaw;
    }
    void Skladnik::SetIle(int x)
    {
        ile = x;
    }
    void Skladnik::SetIleV(int x)
    {
        ile = x;
    }
    Skladnik::~Skladnik()
    ...
    Przyprawa::Przyprawa(string p_nazwa, string p_intensywnosc, string p_smak) : intensywnosc(p_intensywnosc), smak(p_smak)
    {
        nazwa = p_nazwa;
    }
    Przyprawa::Przyprawa(Przyprawa& x)
    {
        nazwa = x.nazwa;
        intensywnosc = x.intensywnosc;
        smak = x.smak;
    }
    ostream& operator << (ostream& s, Przyprawa& x)
    {
        s << x.nazwa << " ";
        s << x.intensywnosc << " ";
        s << x.smak;
    ...
    string Przyprawa::GetName()
    {
        return nazwa;
    }
    string Przyprawa::GetNameV()
    {
        return nazwa;
    }
    pair<int, string> Przyprawa::GetIleV()
    {
        pair<int, string> zestaw(0, "przyprawa");
        return zestaw;
    }
    void Przyprawa::SetIleV(int x)
    {
        int pom=0;
        x >> pom;
    }
    ...
    Przepis::Przepis(string p_nazwa, vector<shared_ptr<Skladnik>> p_skladniki, vector<shared_ptr<Przyprawa>> p_przyprawy, vector<string> p_opis, string p_dieta, int p_kalorycznosc) : nazwa(p_nazwa), skladniki(p_skladniki), przyprawy(p_przyprawy), opis(p_opis), dieta(p_dieta), kalorycznosc(p_kalorycznosc)
    {
        it++;
    }
    istream& operator >> (istream& s, Przepis& x)
    {
        int marker = 0;
    ...
    ostream& operator << (ostream& s, Przepis& x)
    {
        s << x.nazwa << endl;
        s << "skladniki:" << endl;
    ...
    string Przepis::GetName()
    {
        return nazwa;
    }
    string Przepis::GetDiet()
    {
        return dieta;
    }
    vector<string> Przepis::GetOpis()
    {
        return opis;
    }
    vector<shared_ptr<Skladnik>> Przepis::GetSkladnik()
    {
        return skladniki;
    }
    vector<shared_ptr<Przyprawa>> Przepis::GetPrzyprawy()
    {
        return przyprawy;
    }
    int Przepis::GetCal()
    ...
    Dieta::Dieta(string p_nazwa_diety, vector<shared_ptr<Przepis>> p_wszystkie_z_diety) : nazwa_diety(p_nazwa_diety), wszystkie_z_diety(p_wszystkie_z_diety)
    {
    ...
    vector<shared_ptr<Przepis>> Dieta::GetVec()
    {
        return wszystkie_z_diety;
    }
    void Dieta::push(Przepis*& x)
    {
        wszystkie_z_diety.push_back(shared_ptr<Przepis>(new Przepis(*x)));
    }
    void Dieta::push1(Przepis& x)
    {
        wszystkie_z_diety.push_back(shared_ptr<Przepis>(new Przepis(x)));
    }
    ...
    int Modul(int& x)
{
    ...
    void BazaDanych::NadpiszPrzepis(Przepis*& x)
    {
        int marker = 0;
        string pom1, pom2;
    ...
    void BazaDanych::Load()
    {
        ...
        while (!fille.eof())
        {
            ...
            istringstream ss(s);
            ss >> kalorycznosc;
            shared_ptr<Przepis> tymczasowy = (shared_ptr<Przepis>(new Przepis(nazwa, skladniki, przyprawy, opis, dieta, kalorycznosc)));
            przepisy.push_back(tymczasowy);
            pom4.push_back(tymczasowy);
            pom5 = (tymczasowy);
            for (int i = 0; i < diety.size(); i++)
            {
                pom1 = diety[i]->Get();
    ...
    vector<shared_ptr<Przepis>> BazaDanych::Get()
    {
        return przepisy;
    }
    ...
    istream& operator >> (istream& s, Spizarka& x)
    {
        string pom, pom2, pom3, pom4;
        int pom1;
        cin.ignore();
    ...
    void Spizarka::LoadFridge()
    {
        ...
        while (!fille1.eof())
        {
            ...
            stringstream ss(s);
            ss >> pom1 >> pom >> pom3;
            shared_ptr<Skladnik> tymczasowy=(shared_ptr<Skladnik>(new Skladnik(pom1, pom, pom3)));
    ...
    void Spizarka::WhatCanIDo(BazaDanych& x)
    {
